          ...
          <motion.div className="space-y-10" variants={containerVariants}>
            {[
              {
                icon: "Mail",
                title: "Email",
                value: "sunilsahoo5075@gmail.com",
                href: "mailto:sunilsahoo5075@gmail.com",
              },
              {
                icon: "Phone",
                title: "Phone",
                value: "+91-8658263704",
                href: "tel:+918658263704",
              },
              {
                icon: "MapPin",
                title: "Location",
            ...
            >
              <div className="absolute inset-0 flex items-center justify-center">
                <iframe 
                src="https://www.google.com/maps/embed?pb=!3m2!1sen!2sin!4v1780350461760!5m2!1sen!2sin!6m8!1m7!1sj531O5wBjiocPrWwy5XWpw!2m2!1d17.44609862686589!2d78.44902241387021!3f229.11794022825572!4f7.34153963658602!5f0.7820865974627469"
                 width="100%"
                  height="100%"
                  style={{ border: 0 }}
